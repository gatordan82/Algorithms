/******************************************************************************
 *  Compilation:  javac TrieSETBoggle.java
 *  Execution:    java TrieSETBoggle < words.txt
...
/**
 *  The <tt>TrieSETBoggle</tt> class represents an ordered set of strings over
 ...
 *  @author Kevin Wayne
 */
public class TrieSETBoggle implements Iterable<String> {
    ...
    /**
     * Unit tests the <tt>TrieSETBoggle</tt> data type.
     */
    public static void main(String[] args) {
        TrieSETBoggle set = new TrieSETBoggle();
        while (!StdIn.isEmpty()) {
